...
KNOWN_GAP_RULES: list[JsonDict] = [
    ...
    {
        "gap_code": "GAP_TERMINATED_EMPLOYEES",
        "gap_type": GAP_TYPE_DATA,
        ...
        "reason_fa": "View فعلی (vw_hr_employee_analytics) فقط شامل کارمندان فعال است. اطلاعات کارمندان اخراجی، بازنشسته یا ترک‌خدمت در این سیستم موجود نیست.",
        "missing_data": [
            "جدول یا View کارمندان غیرفعال/اخراجی",
            "تاریخ خروج از سازمان",
            "دلیل خروج (اخراج، بازنشستگی، استعفا)",
        ],
        "required_action": "افزودن View یا جدول تاریخچه کارمندان شامل رکوردهای خروج از سازمان.",
        "severity": "high",
    },
]
